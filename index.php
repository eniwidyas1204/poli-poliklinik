            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="">Pasien</h3>
                        <p class="card-text">Untuk mendapatkan layanan kesehatan dari Poliklinik, silahkan login terlebih dahulu</p>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="">Dokter</h3>
                        <p class="card-text">Untuk memulai melayani pasien di Poliklinik, silahkan login terlebih dahulu</p>
                        <div class="d-grid">
